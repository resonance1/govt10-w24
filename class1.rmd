...
You will submit all assignments and problem sets as Markdown files. To create a markdown file, click the down arrow to the right of the *Knit* button and select *Knit to Word*.
